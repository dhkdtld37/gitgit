...
class DateFormatEx2{
	public static void main(String[] args) {
		...
		sdf22 = new SimpleDateFormat("yy-MM-dd EEEE");  //?? 영문요일 
		sdf222 = new SimpleDateFormat("yy-MM-dd EEEE", Locale.ENGLISH);
		sdf3 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss SSS"); // 초
		sdf4 = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss a", Locale.ENGLISH);	// AM, PM
